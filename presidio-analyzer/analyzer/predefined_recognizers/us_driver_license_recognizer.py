"""
Recognizes US driver license number based on regex.

The formats are listed here: https://ntsi.com/drivers-license-format/
"""
...
Therefore we split WA driver license
...
class UsLicenseRecognizer(PatternRecognizer):
    ...
    def __init__(self):
        """Create a US Driver License number recogniser."""
    ...
    def validate_result(self, text, result):
        """Validate US Driver License number - no validation method."""
        return result
