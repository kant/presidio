...
class TestUsLicenseRecognizer(TestCase):
    ...
    # Regex:r'\b([A-Z][0-9]{3,6}|[A-Z][0-9]{5,9}|[A-Z][0-9]{6,8}|
    # [A-Z][0-9]{4,8}|[A-Z][0-9]{9,11}|[A-Z]{1,2}[0-9]{5,6}|H[0-9]{8}|V[0-9]{6}
    # |X[0-9]{8}|A-Z]{2}[0-9]{2,5}|[A-Z]{2}[0-9]{3,7}|
    # [0-9]{2}[A-Z]{3}[0-9]{5,6}|[A-Z][0-9]{13,14}|[A-Z][0-9]{18}|
    # [A-Z][0-9]{6}R|[A-Z][0-9]{9}|[A-Z][0-9]{1,12}|[0-9]{9}[A-Z]|
    # [A-Z]{2}[0-9]{6}[A-Z]|[0-9]{8}[A-Z]{2}|[0-9]{3}[A-Z]{2}[0-9]{4}|
    # [A-Z][0-9][A-Z][0-9][A-Z]|[0-9]{7,8}[A-Z])\b'
    ...
    ''' This test fails, since 'license' is a match and driver is a context.
        It should be fixed after adding support in keyphrase instead of
        keywords (context)
    def test_invalid_us_driver_license(self):
        num = 'C12T345672'
        results = us_license_recognizer.analyze(
            'my driver license is ' + num, entities)
    ...
    # Regex: r'\b([0-9]{1,9}|[0-9]{4,10}|[0-9]{6,10}|[0-9]{1,12}|
    # [0-9]{12,14}|[0-9]{16})\b'  # noqa E501
